...
This data aggregates crime information at the state level and will be used in the workshop to compare homicide levels in CDMX with other states in the country.
...
Group and summarize murder totals by `clave_ent` (state ID), `entidad` (state), and `mes` (month):
